...
List<ProductModel> productItems = [
  ...
  ProductModel(
    ...
    rating: 3.5,
    review: 152, 
    shortDescription: 'Wining beats sound', 
    longDescription: 'AirPods deliver the wireless headphone experience, reimagined. Just pull them out of the Lightning Charging Case and theyre ready to use with your iPhone, Apple Watch, iPad, or Mac. After a simple one-tap setup, AirPods work like magic. Theyre automatically on and always connected.', 
    ),
